...
def export_bilbo_gg(df, df60):
    ...
    NOTE: the live site's bilbo-gg-dates.json is generated by
    scripts/rerun_bilbo_gg_page.py (2000-2025 window, matches the page
    tables); this export is kept join-correct for the legacy path.
    """
    # Merge 60m PO onto 10m data. ind_1h bars are left-labeled: shift to
    # bar-end so a 10m trigger only sees fully closed 1h PO values
    # (look-ahead fix, 2026-04-26 audit).
